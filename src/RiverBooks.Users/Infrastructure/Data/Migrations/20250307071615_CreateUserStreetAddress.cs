...
{
    /// <inheritdoc />
    public partial class CreateUserStreetAddress : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StreetAddress_PostalCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    StreetAddress_State = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    StreetAddress_Street1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    StreetAddress_Street2 = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
